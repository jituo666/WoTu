...
package com.xjt.wotu.data.bitmap;
...
import com.xjt.wotu.common.ThreadPool.CancelListener;
import com.xjt.wotu.common.ThreadPool.JobContext;
import com.xjt.wotu.common.WLog;
import com.xjt.wotu.data.ImageItem;
...
public class BitmapDecoder {
    ...
    public static void decodeBounds(JobContext jc, FileDescriptor fd,
            Options options) {
        UtilsBase.assertTrue(options != null);
