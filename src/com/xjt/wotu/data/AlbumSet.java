...
import com.xjt.wotu.common.FutureListener;
import com.xjt.wotu.common.ThreadPool;
import com.xjt.wotu.common.ThreadPool.JobContext;
import com.xjt.wotu.common.WLog;
import com.xjt.wotu.util.UtilsBase;
import com.xjt.wotu.util.UtilsMedia;
        ...
        synchronized (DataManager.LOCK) {
            ...
            switch (type) {
                case MEDIA_TYPE_IMAGE:
                    return new Album(path, mApplication, id, true, name);
                case MEDIA_TYPE_VIDEO:
                    return new Album(path, mApplication, id, false, name);
                case MEDIA_TYPE_ALL:
