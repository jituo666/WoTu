...
import com.wotu.data.utils.SparseArrayBitmapPool.Node;
...
public class WoTuBitmapPool {
    ...
    private WoTuBitmapPool(int capacityBytes) {
    ...
    private static WoTuBitmapPool sInstance = new WoTuBitmapPool(CAPACITY_BYTES);

    public static WoTuBitmapPool getInstance() {
        return sInstance;
    }
