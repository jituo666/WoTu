...
public class LocalAlbum extends MediaSet {
    ...
    public LocalAlbum(Path path, WoTuApp application, long bucketId,
        ...
        WLog.i(TAG, "Create LocalAlbum, bucket id:" + bucketId);
    ...
    public ArrayList<MediaItem> getMediaItem(int start, int count) {
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                Path childPath = new Path(mItemPath,id);
    ...
    private static MediaItem loadOrUpdateItem(Path path, Cursor cursor,
            DataManager dataManager, WoTuApp app, boolean isImage) {
    ...
    public static MediaItem[] getMediaItemById(
            WoTuApp application, boolean isImage, ArrayList<Integer> ids) {
        ...
        try {
            ...
            while (i < n && cursor.moveToNext()) {
                ...
                Path childPath = new Path(itemPath,id);
