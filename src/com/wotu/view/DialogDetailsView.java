...
import com.wotu.view.DetailsAddressResolver.AddressResolvingListener;
import com.wotu.view.DetailsHelper.CloseListener;
import com.wotu.view.DetailsHelper.DetailsSource;
import com.wotu.view.DetailsHelper.DetailsViewContainer;
import com.wotu.view.DetailsHelper.ResolutionResolvingListener;
...
public class DialogDetailsView implements DetailsViewContainer {
    ...
    public DialogDetailsView(WoTuContext activity, DetailsSource source) {
        mContext = activity;
        mSource = source;
    }
    ...
    private void setDetails(MediaDetails details) {
        ...
        mDialog = new AlertDialog.Builder(mContext.getAndroidContext())
            .setView(detailsList)
            .setTitle(title)
            ...
            for (Entry<Integer, Object> detail : details) {
                ...
                switch (detail.getKey()) {
                    ...
                    default: {
                        ...
                        if (valueObj == null) {
                            UtilsBase.fail("%s's value is Null",
