...
class EdgeAnimation {
    ...
    public void onPull(float deltaDistance) {
        ...
        mValue = UtilsBase.clamp(mValue + deltaDistance, -1.0f, 1.0f);
        mState = STATE_PULL;
    }
    ...
    public void onAbsorb(float velocity) {
        float finish = UtilsBase.clamp(mValue + velocity * VELOCITY_FACTOR,
                -1.0f, 1.0f);
    ...
    public boolean update() {
        ...
        float t = UtilsBase.clamp((float)(now() - mStartTime) / mDuration, 0.0f, 1.0f);
