...
import com.wotu.view.opengl.RawTexture;

public class TransitionAnim extends Animation {
    ...
    public TransitionAnim(Transition t, RawTexture oldScreen) {
        this(Spec.specForTransition(t), oldScreen);
    }

    public TransitionAnim(Spec spec, RawTexture oldScreen) {
